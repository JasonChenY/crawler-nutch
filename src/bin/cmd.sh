...
if [[ $# -ge 1 ]] && [[ $1 = "5.1" ]]; then
    ...
    bin/crawl --solr=http://198.11.181.69:8983/solr/gettingstarted --limit=20 --fetches=100 --id=8983 --seeddir=/sdk/tmp/seed.txt --inject
else
    ...
    bin/crawl --solr=http://127.0.0.1:8080/solr --limit=20 --fetches=100 --id=8080 --seeddir=/sdk/tmp/seed.txt --inject
fi
